...
//        }
        ...
        comps[NSLocale.Key.languageCode.rawValue] = LocalStorage.language.rawValue
        //comps[NSLocale.Key.countryCode.rawValue] = UserDefaultsManager.language.region
...
extension NSLocale {
    ...
    @objc class var appPreferredLanguages: [String] {
        ...
        if !arr.contains(LocalStorage.language.rawValue) {
            arr.insert(LocalStorage.language.rawValue, at: 0)
        }
        return arr
    }
...
extension Locale {
    ...
    fileprivate static func enforceLanguage(_ language: AppLanguage) {
        ...
        Bundle.enforceLanguage(language)
...
//        //UserDefaultsManager.language = AppLanguages.None()
//
//
...
//    }
    ...
    static func setupInitialLanguage() {
        ...
        enforceLanguage(LocalStorage.language)
